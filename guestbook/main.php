...
<body bgcolor="#FFFFFF" text="#000000" background="../image/theme00_main.jpg" bgproperties="fixed" >
<table width=500 border=0 align=center>
<div align="right"><a href="guestbook.php">�d������</a></div>
</table>
<div align="center">
<?php
  //dividing into pages
...
else
{
 ...
 for ($j=1; $j<=$no_of_page; $j++)
   {
      echo "<a href=main.php?no=".$j.">".$j."</a>"." ";
   }

if ($no < $no_of_page)
{
    $next = $no+1;
    echo "><a href=main.php?no=".$next.">";
...
//echo "<tr><td><hr></td></tr>";
?>
<table width=500 align=center border=0 cellpadding=0 cellspacing=3>
<?php  if ($email!="")
    {
?>
                <tr>
...
<p align="center"><a href="../big5/index.html" target="_parent">�^����</a> </p>
</body>
