...
/* Change options below as needed. */
   ...
   $config['installBase']       = "d:/foxServ/www/history/search/" ;  //'/usr/local/apache/htdocs/dgssearch'; /* Where the package was installed. */
   //$config['installBase']       = "/home/customer/fttt.org.tw/ekklesiahistorysearch" ;  //'/usr/local/apache/htdocs/dgssearch'; /* Where the package was installed. */
   ...
   $config['language']          = 'chinese';                            /* Language pack to use. Set english, german, or spanish. */
   ...
   $config['urlBase']           = "http://localhost" ;  //'http://www.xyz.com';                 /* The base URL for your site. */
   //$config['urlBase']           = "http://www.fttt.org.tw" ;  //'http://www.xyz.com';                 /* The base URL for your site. */
   $config['siteBase']          = "d:/foxServ/www/history" ;  '/usr/local/apache/htdocs';           /* The directory that directly coresponds to 'urlBase'. */
   $config['fsBase']            = "d:/foxServ/www/history" ;  //'/usr/local/apache/htdocs';           /* Where we should begin searching the filesystem. */
   //$config['siteBase']          = "/home/customer/fttt.org.tw/www" ;  '/usr/local/apache/htdocs';           /* The directory that directly coresponds to 'urlBase'. */
   //$config['fsBase']            = "/home/customer/fttt.org.tw/www" ;  //'/usr/local/apache/htdocs';           /* Where we should begin searching the filesystem. */
   $config['fsExclude']         = array('^\.ht', '^search$');        /* Files or directories in fsbase to exclude. Regex supported. */
   $config['cacheFile']         = "c:/temp/dgssearch.cache" ; '/tmp/dgssearch.cache';               /* Cache file for files to search. Speeds up searches. */
   //$config['cacheFile']         = "/home/customer/fttt.org.tw/ekklesiahistorycache" ; '/tmp/dgssearch.cache';               /* Cache file for files to search. Speeds up searches. */
